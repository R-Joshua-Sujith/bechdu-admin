...
import EditPromoCode from "../Promo/EditPromoCode";
...
const ViewPromoCode = () => {
  ...
  const savedColumns = localStorage.getItem("promo");
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "Price",
      visible: visibleColumns.discountAmount,
    },
    {
      field: "actions",
      headerName: "Actions",
  ...
  const getCategoryData = async () => {
    await axios
      .get(
        `${apiURL}/promo/get-all-promocode?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}`
  ...
  const confirmDelete = async () => {
    try {
      await axios
        .delete(`${apiURL}/promo/delete/promocode/${categoryID}`)
        .then((res) => {
