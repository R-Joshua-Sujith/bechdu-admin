...
import ViewAbandoned from "./ViewAbandoned";
...
const Abandoned = () => {
  ...
  const savedColumns = localStorage.getItem("abandoned");
  ...
  const columns = [
    ...
    },
    {
      field: "user.city",
      headerName: "City",
      visible: visibleColumns["user.city"],
    },
    {
      field: "user.pincode",
      headerName: "Pincode",
      visible: visibleColumns["user.pincode"],
    },
    {
  ...
  const getCategoryData = async () => {
    await axios
      .get(
        `${apiURL}/abundant/get-all-orders?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}`
