...
const Brand = () => {
  ...
  const columns = [
    ...
    },
    {
      field: "cityName",
      headerName: "City",
      visible: visibleColumns.cityName,
    },
    {
      field: "actions",
      headerName: "Actions",
  ...
  const getCategoryData = async () => {
    await axios
      .get(
        `${apiURL}/pincode/get-all-pincodes?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}`
  ...
  const confirmDelete = async () => {
    try {
      await axios
        .delete(`${apiURL}/pincode/delete-pincode/${categoryID}`)
        .then((res) => {
