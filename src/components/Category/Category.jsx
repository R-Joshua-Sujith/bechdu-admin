...
const Category = () => {
  ...
  const savedColumns = localStorage.getItem("category");
  ...
  const columns = [
    {
      field: "category_type",
      headerName: "Category",
      visible: visibleColumns.category_type,
    },
    {
      field: "slug",
      headerName: "Slug",
    ...
    },
    {
      ...
      visible: visibleColumns.sectionCount,
    },
    {
      field: "actions",
      headerName: "Actions",
  ...
  const getCategoryData = async () => {
    await axios
      .get(
        `${apiURL}/api/category/get-all-categories?page=${currentPage}&pageSize=${pageSize}&search=${searchQuery}`
                      ...
                      <td key={column.field}>
                        {column.field === "actions" ? (
                          ...
                          <div className="action-container">
                            ...
                            />
                            {selectedRow === row.id && !isEditModalOpen && (
